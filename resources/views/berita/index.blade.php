                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    @foreach($berita as $item)
                        <a href="{{ route('berita.show', $item->slug) }}" class="block">
                            <div class="bg-white border border-gray-300 rounded-lg shadow-md overflow-hidden flex flex-col relative hover:border-red-600 transition-all duration-300">
